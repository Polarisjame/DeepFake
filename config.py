...
def get_opt():
    ...
    parser.add_argument('--force_generate', type=int, default=0, help='force process audio file')
    parser.add_argument('-nu', '--num_workers', type=int, default=3, help='thread number')
    
    # Model
    parser.add_argument('--video_pretrained_dir', type=str, default='checkpoints/swin_base_patch244_window1677_kinetics400_22k_host.pth')

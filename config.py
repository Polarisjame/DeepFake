...
def get_opt():
    ...
    parser.add_argument('--soft', type=float, default=0.01, help='NCE-SoftParam')
    ...
    parser.add_argument('--align_loss_rate', type=float, default=0.4, help='Ratio of Loss_align')
